 ...
 */
package com.udacity.sunshine.task;
...
//            String[] resultStrs = convertContentValuesToUXFormat(cVVector);
    ...
    protected Void doInBackground(String[] params) {
        ...
        try {
            ...
            Log.e(TAG, "Error ", e);
            // If the code didn't successfully get the weather data, there's no point in attempting(试图)
            // to parse it.
            return null;
        } catch (JSONException e) {
            Log.e(TAG, e.getMessage(), e);
...
//       // those code are not useful any more.
//    @Override
