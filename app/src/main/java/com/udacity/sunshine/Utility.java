...
public class Utility {
    ...
    public static String getFormattedWind (Context context, float windSpeed, float degrees) {
        ...
        // From wind direction(方向) in degrees(角度), determine(确定) compass(指南针) direction as a string (e.g NW)
        // You know what's fun, writing really long if/else statements with tons of possible conditions(情况). Seriously, try it!
